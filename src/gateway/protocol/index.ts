...
import {
  ...
  type AgentsPlanGetParams,
  AgentsPlanGetParamsSchema,
  type AgentsPlanGetResult,
  AgentsPlanGetResultSchema,
...
export const validateAgentsPlanGetParams = ajv.compile<AgentsPlanGetParams>(
  AgentsPlanGetParamsSchema,
);
